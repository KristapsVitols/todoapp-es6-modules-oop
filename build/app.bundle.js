...
var _task = __webpack_require__(329);
...
//Add task
function addTask() {
	if (_ui.ui.taskInput.value === '') {
		_ui.ui.showError();
	} else {
		_task.task.addTask(_ui.ui.taskInput.value);
		_ui.ui.clearError();
		_ui.ui.clearInput();
	}
}
...
function deleteTask(e) {
	_task.task.deleteTask(e);
}

//Toggle Complete task
function toggleCompleteTask(e) {
	_task.task.toggleCompleteTask(e);
}
...
var Task = function () {
	...
	_createClass(Task, [{
		...
		value: function toggleCompleteTask(e) {
			if (e.target.classList.contains('complete')) {
				...
				var _li = e.target.parentElement.parentElement;
				_li.className = '';
			}
		}
	}]);
...
var task = exports.task = new Task();
